import { Check, LucidePanelLeftOpen, Search } from "lucide-react"
...
const SidebarRight = () => {
    ...
    return (
        <>
            < div className="group w-[385px] pt-3 pl-3 pr-5 h-[80vh] bg-neutral-950 mt-5 rounded-[5px] text-white overflow-y-auto scrollbar-hidden">
                ...
                <div className="mt-4">
                    <img src="https://avatars.yandex.net/get-music-content/15401259/5b706773.a.35470856-1/m1000x1000" className="w-full rounded-[5px]" />
                </div>

                <div className="flex items-center justify-between gap-1 mt-3">
                    <div>
                        <h1 className="text-2xl font-semibold">PASSO BEM SOLTO</h1>
                        <p className="text-neutral-400">ATLXS</p>
                    </div>
